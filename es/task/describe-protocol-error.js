...
export default function describeProtocolError(code) {
  return new ProtocolError(code, getShortDescription(code), getFullDescription(code));
}
...
//# sourceMappingURL=describe-protocol-error.js.map