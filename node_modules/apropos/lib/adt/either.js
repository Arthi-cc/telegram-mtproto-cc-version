...
class Isomer extends _base2.default {}
...
class EitherRight extends Isomer {
  ...
  toString() {
    return 'Right( ' + (0, _util.failSafeStringify)(this.value) + ' )';
  }
}
...
class EitherLeft extends Isomer {
  ...
  toString() {
    return 'Left( ' + (0, _util.failSafeStringify)(this.value) + ' )';
  }
}
(0, _util.addInterop)(EitherRight, 'Either');
(0, _util.addInterop)(EitherLeft, 'Either');
